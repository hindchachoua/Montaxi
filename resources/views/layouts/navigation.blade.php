<nav x-data="{ open: false }" style="  background-image: linear-gradient(to top, rgb(218, 108, 255), rgb(133, 65, 155));" >
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button  class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md focus:outline-none transition ease-in-out duration-150">
                            <div style="color:rgb(255, 255, 255)">{{ Auth::user()->name }}</div>
                    ...
                    <x-slot name="content">
                        <x-dropdown-link  style="background-color: rgb(78, 0, 104)" :href="route('profile.edit')">
                            {{ __('Profile') }}
                        </x-dropdown-link>
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <x-dropdown-link  style="background-color: rgb(78, 0, 104)" :href="route('logout')"
